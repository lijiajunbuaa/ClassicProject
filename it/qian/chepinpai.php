...
if (isset($_GET['PINPAI'])) {
  $colname_Recordset1 = $_GET['PINPAI'];
}
mysql_select_db($database_conn, $conn);
$query_Recordset1 = sprintf("SELECT * FROM it_pinpai WHERE pinpaizhi = %s ORDER BY xiliezhi ASC", GetSQLValueString($colname_Recordset1, "text"));
$Recordset1 = mysql_query($query_Recordset1, $conn) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
mysql_select_db($database_conn, $conn);
$query_Recordset1 = "SELECT * FROM it_pinpai WHERE pinpaizhi = $colname_Recordset1 GROUP BY xiliezhi ORDER BY xiliezhi ASC";
$Recordset1 = mysql_query($query_Recordset1, $conn) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
.chepinpai1{
	width:500px;font-family:"微软雅黑";font-size:15px;position:relative;left:37px;bottom:433px;
			margin-top:10px;}
			.chepinpai1 div{margin-top:10px;}
			.chepinpai1 a{color:#00BBFF;text-decoration:none;
			border-style:solid;
			border-width:1px;
			border-color:#1ECD97;
			border-radius:4px;}
  ...
  <div class="chepinpai1" style="font-size:18px;"> <?php echo $row_Recordset1['pinpai']; ?></div>
  	<!--记录条数--> <div class="chepinpai1" style="position:relative;left:300px;">  (总共 <?php echo $totalRows_Recordset1 ?> 个搜索结果)</div>
   <div class="chepinpai1"  style="width:480px;height:1px; background:#E0E0E0;position:relative;"></div>
          <?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
           <?php do { ?>
           
             <div class="chepinpai1"><img src="tupian/<?php echo $row_Recordset1['xilie']?>/flash/flowList/01.jpg" width="60px;" height:"40px;">
             <a style="position:absolute;left:73px;bottom:27px;" href="chedetail.php?che=<?php echo $row_Recordset1['xilie']?>" target="_blank"><?php echo $row_Recordset1['xilie']; ?></a>
