...
$query_Recordset1 = "SELECT * FROM it_shoucangjia,it_car,it_pinpai WHERE it_shoucangjia.user='$user' and it_shoucangjia.carid=it_car.id and it_car.车型=it_pinpai.xilie";
...
<script language="javascript">
 ...
 var url;
 url="verifySHANCHU.php?user="+user1+"&carid="+carid1;
 ...
 xmlHttp.send(null);
		...
		xmlHttp.onreadystatechange=function(){
			...
			margin-top:10px;}
			.shoucang1 a{color:#00BBFF;text-decoration:none;
			border-style:solid;
			border-width:1px;
			border-color:#1ECD97;
			border-radius:4px;}
			.shoucang1 input[type='submit']{
				...
				font-size:8px;
							...
							outline:none;
							text-align:center}
							.shoucang1 input[type='submit']:hover{
								background-color:#1ECD97;}
            </style>
 <div class="shoucang1">  (总共 <?php echo $totalRows_Recordset1 ?> 个收藏) </div>
  <div class="shoucang1" style="width:480px;height:1px; background:#E0E0E0;position:relative;"></div> 
<?php do { ?>
  ...
  <div class="shoucang1">
    ...
    <span>  <?php echo $row_Recordset1['shijian']; ?></span>
    <a style="position:relative;left:3px;" href="chedetail.php?che=<?php echo $row_Recordset1['车型']; ?>" target="_blank"><span><?php echo $row_Recordset1['车型']; ?></span></a>
    &nbsp;&nbsp;<?php echo $row_Recordset1['款式']; ?>&nbsp;<?php echo $row_Recordset1['厂商指导价']; ?>&nbsp;<?php echo $row_Recordset1['jibie']; ?>&nbsp;<?php echo $row_Recordset1['shangshinian']; ?>年款
    
    <input  type="submit" value="删除" onclick="shanchu('<?php echo $row_Recordset1['user'];?>','<?php echo $row_Recordset1['carid'];?>')">
  </div>
