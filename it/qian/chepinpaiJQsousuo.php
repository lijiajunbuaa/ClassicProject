...
$SHANGSHINIAN="";
$PINGFEN="综合";
$PINGFEN=$_POST['RadioGroup2'];
if(isset($_POST['RadioGroup1'])){$JIBIE=$_POST['RadioGroup1'];}
if($_POST['zuidijia']!=""){$ZUIDIJIA=$_POST['zuidijia'];}else if($_POST['zuidijia']==""){$ZUIDIJIA="0";}
if($_POST['zuigaojia']!=""){$ZUIGAOJIA=$_POST['zuigaojia'];}else if($_POST['zuigaojia']==""){$ZUIGAOJIA="9999999";}
if(isset($_POST['shangshinian'])){$SHANGSHINIAN=$_POST['shangshinian'];}

mysql_select_db($database_conn, $conn);
if($PINGFEN=='综合'){
$query_Recordset1 = "SELECT * FROM it_pinpai where jibie like '%".$JIBIE."%' and zuidijia>=".$ZUIDIJIA." and zuigaojia<=".$ZUIGAOJIA." and shangshinian like '%".$SHANGSHINIAN."%' GROUP BY xilie ORDER BY zonghe desc";
}
if($PINGFEN=='空间'){
$query_Recordset1 = "SELECT * FROM it_pinpai where jibie like '%".$JIBIE."%' and zuidijia>=".$ZUIDIJIA." and zuigaojia<=".$ZUIGAOJIA." and shangshinian like '%".$SHANGSHINIAN."%' GROUP BY xilie ORDER BY kongjian desc";
}
if($PINGFEN=='动力'){
$query_Recordset1 = "SELECT * FROM it_pinpai where jibie like '%".$JIBIE."%' and zuidijia>=".$ZUIDIJIA." and zuigaojia<=".$ZUIGAOJIA." and shangshinian like '%".$SHANGSHINIAN."%' GROUP BY xilie ORDER BY dongli desc";
}
if($PINGFEN=='操控'){
$query_Recordset1 = "SELECT * FROM it_pinpai where jibie like '%".$JIBIE."%' and zuidijia>=".$ZUIDIJIA." and zuigaojia<=".$ZUIGAOJIA." and shangshinian like '%".$SHANGSHINIAN."%' GROUP BY xilie ORDER BY caokong desc";
}
if($PINGFEN=='油耗'){
$query_Recordset1 = "SELECT * FROM it_pinpai where jibie like '%".$JIBIE."%' and zuidijia>=".$ZUIDIJIA." and zuigaojia<=".$ZUIGAOJIA." and shangshinian like '%".$SHANGSHINIAN."%' GROUP BY xilie ORDER BY youhao desc";
}
if($PINGFEN=='舒适'){
$query_Recordset1 = "SELECT * FROM it_pinpai where jibie like '%".$JIBIE."%' and zuidijia>=".$ZUIDIJIA." and zuigaojia<=".$ZUIGAOJIA." and shangshinian like '%".$SHANGSHINIAN."%' GROUP BY xilie ORDER BY shushi desc";
}
if($PINGFEN=='外观'){
$query_Recordset1 = "SELECT * FROM it_pinpai where jibie like '%".$JIBIE."%' and zuidijia>=".$ZUIDIJIA." and zuigaojia<=".$ZUIGAOJIA." and shangshinian like '%".$SHANGSHINIAN."%' GROUP BY xilie ORDER BY waiguan desc";
}
if($PINGFEN=='性价比'){
$query_Recordset1 = "SELECT * FROM it_pinpai where jibie like '%".$JIBIE."%' and zuidijia>=".$ZUIDIJIA." and zuigaojia<=".$ZUIGAOJIA." and shangshinian like '%".$SHANGSHINIAN."%' GROUP BY xilie ORDER BY xingjiabi desc";
}
...
.JQsousuo1{
	width:500px;font-family:"微软雅黑";font-size:15px;position:relative;left:37px;bottom:433px;
			margin-top:10px;}
			.JQsousuo1 div{margin-top:10px;}
			.JQsousuo1 a{color:#00BBFF;text-decoration:none;
			border-style:solid;
			border-width:1px;
			border-color:#1ECD97;
...
<div class="JQsousuo1" style="position:relative;left:300px;">(总共 <?php echo $totalRows_Recordset1 ?> 个搜索结果)</div>
<div class="JQsousuo1"  style="width:480px;height:1px; background:#E0E0E0;position:relative;"></div>
<?php if ($totalRows_Recordset1 > 0) { // Show if recordset not empty ?>
<?php do { ?>
<div class="JQsousuo1"><img src="tupian/<?php echo $row_Recordset1['xilie']?>/flash/flowList/01.jpg" width="60px;" height:"40px;">
